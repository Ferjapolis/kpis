        ...
        <v-form ref="form" v-model="valid" lazy-validation>
          <v-row class="pt-4">
            <v-col cols="4" class="pl-14">
              ...
              <v-col cols="12">
                <div class="pt-14" id="tabla-kpi">
                  <v-row style="font-size:2em">
                    <v-col cols="5">
                  ...
                  <v-row v-for="(mes, k) in desserts" :key="k" class="table-row">
                    <v-col cols="5" justify="right">
                      <h4 class="pl-4 text-right pr-4" style="text-align: center !important;">{{mes.name}}</h4>
                    </v-col>
            ...
            <v-col cols="8" class="d-flex align-center">
              <v-row class="d-row align-content-center pa-10">
                <v-col cols="12">
                  <v-row class="pt-4 pl-9 pb-7 justify-center">
                    <h4 style="font-size:2em">Tipo de Gráfico:</h4>
                  </v-row>
